<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-bold text-gray-800">Edit Group: {{ $group->name }}</h2>
    </x-slot>
            ...
            <form method="POST" action="{{ route('groups.update', $group) }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="3"
                              ...
                              placeholder="What is this group for?">{{ old('description', $group->description) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    @if($group->image)
                        <div class="mt-1 mb-2">
                            <img src="{{ asset('storage/' . $group->image) }}" alt="{{ $group->name }}" class="w-16 h-16 rounded-lg object-cover" />
                        </div>
                    @endif
