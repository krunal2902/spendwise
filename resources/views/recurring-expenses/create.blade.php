<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-bold text-gray-800">Create Recurring Expense</h2>
    </x-slot>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <form method="POST" action="{{ route('recurring-expenses.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="description" name="description" type="text" class="mt-1 block w-full" :value="old('description')" placeholder="e.g., Netflix subscription, Rent payment" />
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        <x-input-label for="next_due_date" :value="__('First Due Date')" />
                        <x-text-input id="next_due_date" name="next_due_date" type="date" class="mt-1 block w-full" :value="old('next_due_date', date('Y-m-d'))" required />
                ...
                <div class="flex items-center gap-4 mt-6">
                    <x-primary-button>{{ __('Create Recurring Expense') }}</x-primary-button>
