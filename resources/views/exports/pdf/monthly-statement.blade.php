...
<body>
    ...
    <div class="header">
        <div class="header-left">
            <h1 class="title">Expenseflow Statement</h1>
    ...
    <div class="footer">
        Generated by Expenseflow. All amounts are in INR (₹). This defines a summary snapshot of your balances for the stipulated time period.
    </div>
